      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#002855]">Matriz de Riesgos y Oportunidades</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-slate-50/50">
              <tr>
                <th className="p-4 text-sm font-bold text-slate-600 whitespace-nowrap">Riesgo / Oportunidad</th>
                <th className="p-4 text-sm font-bold text-slate-600">Área / Proceso</th>
                <th className="p-4 text-sm font-bold text-slate-600 text-center">Prob.</th>
                <th className="p-4 text-sm font-bold text-slate-600 text-center">Imp.</th>
                <th className="p-4 text-sm font-bold text-slate-600 text-center">Nivel</th>
                <th className="p-4 text-sm font-bold text-slate-600">Plan de Acción (Control)</th>
                <th className="p-4 text-sm font-bold text-slate-600">Fecha Límite</th>
                <th className="p-4 text-sm font-bold text-slate-600">Evaluación</th>
              </tr>
            </thead>
                  ...
                  <tr key={r.id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="p-4">
                      <div className="flex flex-col items-start gap-1">
                        ...
                        <p className="font-medium text-[#002855]">{r.riesgo}</p>
                      </div>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      <input 
                        ...
                        className="p-1.5 text-sm font-medium text-slate-600 bg-slate-50 border border-slate-200 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-cyan-500"
                      />
                    </td>
                    <td className="p-4">
                      <select 
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
          <div className="bg-white rounded-2xl p-0 w-full max-w-xl shadow-2xl overflow-hidden animate-slide-up">
            ...
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-bold text-slate-600 mb-1.5">Tipo de Registro</label>
              ...
              <div>
                <label className="block text-sm font-bold text-slate-600 mb-1.5">Descripción del {nuevoRiesgo.tipo}</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-slate-600 mb-1.5">Área / Departamento</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-600 mb-1.5">Proceso Relacionado</label>
              ...
              <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
                <div>
                  <label className="block text-sm font-bold text-slate-600 mb-1.5 flex justify-between">Probabilidad <span>{nuevoRiesgo.probabilidad}</span></label>
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-600 mb-1.5 flex justify-between">Impacto <span>{nuevoRiesgo.impacto}</span></label>
