        ...
        <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
          <div>
            ...
            <p className="text-sm opacity-80 mt-1 flex items-center gap-2">
              <span className="font-mono bg-white/10 px-2 py-0.5 rounded">Folio: {form.folio_codigo || 'Pendiente de aprobación'}</span>
            </p>
          </div>
                          ...
                          {enFaseAuditoria ? (
                            <div className="flex flex-col gap-2">
                              {a.evidencia_real ? (
                                ...
                                <span className="text-xs text-slate-400 italic">Sin evidencia</span>
                              )}
                            </div>
                          ) : (
                            <div className="flex flex-col gap-2">
