        ...
        <>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1.5">Número de Auditoría</label>
        ...
        <>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-4">
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1.5">Actividad Específica</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-1.5">Fecha de término</label>
