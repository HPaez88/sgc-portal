...
export function StatCard({ title, value, icon: Icon, trend, trendUp, color = 'cyan' }) {
  return (
    <div className="group glass-card-dark p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer relative overflow-hidden">
