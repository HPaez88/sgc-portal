          ...
          <div className="divide-y divide-slate-100">
            {actividadesRecientes.length > 0 ? actividadesRecientes.map((act) => (
              ...
              <div className="p-12 text-center text-slate-500 flex flex-col items-center">
                <div className="bg-slate-100 p-4 rounded-full mb-3"><FileText size={32} className="text-slate-400"/></div>
                <p className="font-bold text-slate-600">No hay actividad reciente</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div className="p-5">
              <div className="flex justify-between items-end mb-2">
                <div>
                  <p className="text-3xl font-black text-[#002855]">{auditoriasCompletadas} <span className="text-sm text-slate-400 font-medium">/ {safeAuditorias.length}</span></p>
