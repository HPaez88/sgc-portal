    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-cyan-200 transition-colors">
          ...
          <p className="font-semibold text-[#002855]">{form.gerencia_coordinacion || '-'}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-cyan-200 transition-colors">
          <p className="text-xs text-slate-500 font-bold mb-1">CATEGORÍA</p>
          <p className="font-semibold text-[#002855]">{form.categoria_mejora || '-'}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-cyan-200 transition-colors">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-cyan-200 transition-colors">
          ...
          <p className="font-semibold text-[#002855]">{form.periodo_mejora || '-'}</p>
        </div>
      </div>
